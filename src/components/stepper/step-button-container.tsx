  ...
  return (
    <Button
      ...
      className={cn(
        ...
        'data-[active=true]:bg-sky-950 data-[active=true]:border-sky-950 data-[active=true]:text-primary-foreground',
        'data-[current=true]:border-sky-950 data-[current=true]:bg-secondary',
